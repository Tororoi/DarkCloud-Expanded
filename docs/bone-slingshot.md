...
(`CustomToanEffects.BoneRapierEffect(true)` — `Dungeon.SetBypassBoneDoor` — driven from the Xiao weapon switch in
...
Both bone weapons also keep the undead down, as the Cross Hinder does: `CustomToanEffects.BoneKeyNoRevivalEffect`
