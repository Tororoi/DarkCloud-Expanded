...
(brownboo_viewer.html) next to this script. Requires tools/lib/extract_scene_mesh.py and a local
data.hed/hd2/dat extraction (see extract_scene_mesh.DAT_DIR).

Run: python3 tools/brownboo/brownboo_viewer.py   ->  tools/brownboo_viewer.html (+ .json)
"""
...
# ---- render via the shared scene viewer (tools/lib/scene_viewer_html.py): z-buffer occlusion, layer
