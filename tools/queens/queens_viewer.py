...
Decodes gedit/e03/scene.scn with correct world placement (tools/lib/scene_placed.py: mapinfo GROUND transforms
...
viewer via the shared renderer (tools/lib/scene_viewer_html.py): per-layer show/hide, fill/wire/backface-cull,
...
Run: python3 tools/queens/queens_viewer.py  ->  game_data/queens/queens_viewer.html
"""
...
from georama_parts import part_models, default_layout
...
#      Ladder from tools/queens/carve_queens_ladder.py (donor e05a01 'hasigo1'); sign = the real kanban mesh.
