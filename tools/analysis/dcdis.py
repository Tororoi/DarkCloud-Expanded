...
Usage: python3 tools/analysis/dcdis.py <hexvaddr> [num_insns]
       python3 tools/analysis/dcdis.py sym <substring>      # search symbols by name
       python3 tools/analysis/dcdis.py xref <hexoffset> [base_reg]  # find lwc1/swc1 at given offset
"""
import os
