...
# Originals are direct game extractions -> the untracked game_data/brownboo/ tree (never committed).
OUT = os.path.join(os.path.dirname(__file__), '..', 'game_data', 'brownboo', 'rock_obj')
