...
namespace Dark_Cloud_Improved_Version
{
    public partial class MiniBoss
    {
        ...
        // so this lives in FasterEnemies.ScaleAnimation — the single PlayingMotionSpeed writer — where it composes
