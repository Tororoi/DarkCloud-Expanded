...
namespace Dark_Cloud_Improved_Version
{
    ...
    internal sealed class StbWriter
    {
        ...
        /// <summary>
        /// CALL_FUNC (op 19): call the funcdata at <paramref name="funcCodeBaseOffset"/> — a codeBase-relative FILE
        ...
        /// </summary>
        internal void CallFunc(int funcCodeBaseOffset) => Emit(OpCallFunc, 0, unchecked((uint)funcCodeBaseOffset));
