...
{
    /// <summary>
    /// The fishing dispatch-label scripts. Per spot: the ENTRY script (prompt-don't-pounce "!", vanilla entry menu, rod
    /// check, fade, villager clear, fishing-Toan swap, _LOAD_FISHING_DATA/_INIT_FISH, stance, _GOTO_FISHING)
    /// and the EXIT script (label 133: confirm menu, fade, restore Toan in place, _EXIT_FISHING, villager
    /// reload); plus the standalone bait menu (134), canal-ladder message (402) and tide-evict warp (403).
    /// </summary>
    internal static class FishingScripts
    {
        ...
        // ── The small dispatch-label scripts (moved from FishingScriptBuilder 2026-09) ─────────────
