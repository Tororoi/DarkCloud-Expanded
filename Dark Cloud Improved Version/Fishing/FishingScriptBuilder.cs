...
{
    /// <summary>
    /// STB bytecode emit primitives for the fishing scripts, built on StbWriter: wait loops, the cursor
    /// menu (inline + CALL_FUNC subroutine forms, incl. the shared label-9600 subroutine that lives with
    /// its machinery here) and message show/close. Spot-free by design. The dispatch-label SCRIPTS —
    /// entry/exit, bait 134, ladder message 402, tide-evict warp 403 — live in FishingScripts.
    /// 
