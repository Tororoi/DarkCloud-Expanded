...
namespace Dark_Cloud_Improved_Version
{
    public class MainMenuThread
    {
        ...
        internal static void ApplyNewChanges()
        {
            ...
            BorrowedShots.Start(DragonsY.WantedShot, BanditSlingshot.WantedShot, BigBang.WantedShot, SwordOfZeus.WantedShot);   // shot effects borrowed for Xiao's abilities, entered on every floor; each ability names the one it wants
