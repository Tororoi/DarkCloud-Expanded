...
namespace Dark_Cloud_Improved_Version
{
    class DayRandomizers
    {
        ...
        */
                                    ...
                                    if (Player.InDungeonFloor() == true && (Memory.ReadUInt(Addresses.dungeonDebugMenu) == 0 || Memory.ReadUInt(Addresses.dungeonDebugMenu) == 10))
                                    {
                                        ...
                                        if (validElement == true)
                                        {
                                            if (elementSelected >= 0 && elementSelected <= 5)
                                            {
                                                ...
                                                DungeonMessages.DisplayMessage("Changed current attribute to " + elementName[elementSelected], 1, width, 1000);
                                                Thread.Sleep(1100);
                                            }
                                        }
                                    }
        ...
        // UNUSED TEST CODE (kept commented out)
        /*
        ...
        public static void Testing()
        {
            ...
            while (1 == 1)
            {
                ...
                //            {
                //                godMode = false;
                //                Memory.WriteByteArray(Addresses.dunMessage10, DungeonMessages.DisplayMessage("God Mode deactivated.             \n                    \nYou are no longer invincible to enemy damage."));
                //            }

                //            else if (godMode == false)
                //            {
                //                godMode = true;
                //                DungeonMessages.DisplayMessage("God Mode activated.             \n                          \nYou are now invincible to enemy damage.      ");
                //            }
                //        }
                //    }
                //}
