    ...
    internal static class StbLabelBaker
    {
        ...
        internal static readonly int[] FishingSpareLabelIds   =
            { MenuSubLabelId, FishingLabelId, CanalFishingLabelId, EventPoints.FishingExitLabel,
              EventPoints.FishingBaitLabel, LadderMsgLabelId, CanalWarpLabelId, AllySwapLabelId, ClothResetLabelId };   // menu, enter, canal-enter, quit, bait, ladder-msg, tide-evict, ally-swap, cloth-reset
        internal static readonly int[] FishingSpareLabelSizes = { 0x800, 0xA00, 0xA00, 0x500, 0x300, 0x300, 0x100, 0x600, 0x100 };               // one size per id, same order
