...
namespace Dark_Cloud_Improved_Version
{
    ...
    internal static class WeaponDescriptions
    {
        ...
        // Sword's "Sevenfold Rite" (gate +7, 77% transfer — SevenBranchSword.SevenfoldRiteEffect).
        ...
        /// version (+7 / 77%) or vanilla (60%). Called by SevenBranchSword.SevenfoldRiteEffect as the
