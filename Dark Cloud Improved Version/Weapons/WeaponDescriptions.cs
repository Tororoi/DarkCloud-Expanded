...
namespace Dark_Cloud_Improved_Version
{
    ...
    /// Full RE notes: docs/weapon-descriptions.md; encoding mirrors tools/analysis/mes_decode.py.
    ///
    ...
    internal static class WeaponDescriptions
    {
        ...
        // Sword's "Sevenfold Rite" (gate +7, 77% transfer — SevenBranchSword.SevenBranchSwordEffect).
        ...
        /// version (+7 / 77%) or vanilla (60%). Called by SevenBranchSword.SevenBranchSwordEffect as the
        ...
        /// (docs/weapon-descriptions.md; mirrors tools/analysis/mes_decode.py encode()).</summary>
