...
namespace Dark_Cloud_Improved_Version
{
    ...
    internal static class IsoPatcher
    {
        ...
        internal static readonly float[] LadderClimbTop    = { LadderWorldX, 70f, 54.9f };
        ...
        internal const uint BootCaveAddr = 0x002A2314, BootCaveStringAddr = 0x002452B8, BootCaveDiagAddr = 0x01F80000;
        internal const int  BootCaveMaxBytes = 0x6C;
        ...
        internal static uint ApplySignPatch(FileStream fs, Action<string> progress)
        {
            ...
            void Redirect(string name, byte[] data)
            {
                ...
                uint sec = (uint)(tail >> 11), cnt = (uint)((data.Length + SectorBytes - 1) / SectorBytes);
            ...
            Redirect(BootTexturePak, PakPrepend(ReadArchive(BootTexturePak), "fishsign.img", e01b24Img));
            ...
            byte[] s04scene = ReadArchive(BrownbooScene);
            ...
            Redirect(BrownbooScene, CullBuildings(CullUpperCraterWalls(RemoveRingCornerTris(
                                    BuildInjectedScene(s04scene, kanbanMds, tmplHdr, funcData: BuildFishingFunc(BrownbooTriggerOffset))))));
            Redirect(MAPINFO,   BuildInjectedMapinfo(ReadArchive(MAPINFO), BrownbooSignX, BrownbooSignY, BrownbooSignZ, BrownbooSignRotY, "s04a01"));
            ...
            Redirect(QueensScene, e03scene);

            byte[] e03map = BuildInjectedMapinfo(ReadArchive(QueensMapinfo), QueensSignX, QueensSignY, QueensSignZ, QueensSignRotY, QueensAnchorPart, "kanban_a.mds");
