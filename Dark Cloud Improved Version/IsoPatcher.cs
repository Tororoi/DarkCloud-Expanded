    ...
    internal static class IsoPatcher
    {
        ...
        static void PatchNativeCameraPostPass(FileStream fs, Func<uint, long> ElfOff)
        {
            ...
            uint[] pullIn =
            {
                ...
                0x8D690004, 0x8D6A0008, 0x01094025, 0x010A4025, 0x11000178, 0x00000000,
                ...
                0x00000000, 0x45010163, 0x00000000, 0x3C083F80, 0x44884000, 0x00000000,
                ...
                0xAFA90014, 0xAFA00018, 0x0C052754, 0x00000000, 0x8FA30058, 0x04400129,
                ...
                0x44805000, 0x00000000, 0x460B5034, 0x00000000, 0x450000FA, 0x00000000,
                ...
                0xE46302D8, 0x8FA80084, 0x15000012, 0x00000000, 0x3C0842A0, 0x44883800,
                0x00000000, 0x460039C1, 0xC7A90088, 0x46093AC2, 0x3C083D00, 0x44886800,
                0x00000000, 0x460C58C2, 0x460018C7, 0x460D18C2, 0x46033180, 0x460018C3,
                0xC46902D8, 0x46034A40, 0xE46902D8, 0x3C0842A0, 0x44883800, 0x00000000,
                0x460039C1, 0x8FA80098, 0x05000003, 0x00000000, 0x44803800, 0x00000000,
                0x44804000, 0x00000000, 0x46083FE8, 0x460739C2, 0x3C083C0C, 0x3508CCCD,
                0x44884000, 0x00000000, 0x460839C2, 0x3C084188, 0x44884000, 0x00000000,
                0x460839C0, 0xC7A8008C, 0x46083FE8, 0xC7A80090, 0x46083FE9, 0xC7A80068,
                0x46083941, 0x46003886, 0xC7A70060, 0x460039C2, 0xC7A80020, 0x460741C0,
                0xE7A70070, 0xC7A80024, 0x46024200, 0xE7A80074, 0xC7A70064, 0x460039C2,
                0xC7A80028, 0x460741C0, 0xE7A70078, 0xAFA0007C, 0xE7A00094, 0xE7A20098,
                0xE7A4009C, 0xE7A50080, 0xE7A60088, 0x3C0B0014, 0x356BC210, 0x02A02021,
                0x03C02821, 0x01603021, 0x27A70070, 0x0C052754, 0x00000000, 0x8FA30058,
            ...
            PutVal(436, BASE_DIST, nameof(BASE_DIST));   // reacquisition rest target
            PutVal(453, BASE_DIST, nameof(BASE_DIST));   // climb intrusion reference
            PutVal(151, REST_H, nameof(REST_H));   // flat baseline
            PutVal(471, REST_H, nameof(REST_H));   // climb-curve base
            ...
            PutVal(552, SLIDE_MARGIN, nameof(SLIDE_MARGIN));   // corner second-resolution standoff
            ...
            PutEase(426, 427, SLIDE_FRICTION, nameof(SLIDE_FRICTION));
