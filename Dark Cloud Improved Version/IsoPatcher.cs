    ...
    internal static class IsoPatcher
    {
        ...
        static void PatchNativeCameraPostPass(FileStream fs, Func<uint, long> ElfOff)
        {
            ...
            uint[] pullIn =
            {
                ...
                0x8C239678, 0x10600269, 0x00000000, 0xAFA30058, 0xC46002C0, 0xE7A00020,
                ...
                0x10000002, 0x00000000, 0x44800000, 0x3C0B0014, 0x356BC20C, 0xC5620000,
                ...
                0xC7A20064, 0x46011082, 0xC46302C8, 0x46021880, 0xE7A20038, 0x02A02021,
                0x03C02821, 0x27A60020, 0x3C070014, 0x34E7C210, 0x0C052754, 0x00000000,
                0xAFA20098, 0x8FA30058, 0xAFA0003C, 0x3C0B0014, 0x356BC210, 0x8D680000,
                0x8D690004, 0x8D6A0008, 0x01094025, 0x010A4025, 0x1100017B, 0x00000000,
                ...
                0x00000000, 0x45010166, 0x00000000, 0x3C083F80, 0x44884000, 0x00000000,
                0x46084834, 0x00000000, 0x4501001F, 0x00000000, 0x46090244, 0x00000000,
                ...
                0xE7A70078, 0xAFA0007C, 0x10000008, 0x00000000, 0xC7A70030, 0xE7A70070,
                0xC7A70034, 0xE7A70074, 0xC7A70038, 0xE7A70078, 0xAFA0007C, 0x02A02021,
                0x03C02821, 0x01603021, 0x27A70070, 0x27A80040, 0xAFA80010, 0x24090001,
                0xAFA90014, 0xAFA00018, 0x0C052754, 0x00000000, 0x8FA30058, 0x0440012C,
                0x00000000, 0x00024980, 0x00025100, 0x012A4821, 0x02A94821, 0xC5240030,
                0xC5250034, 0xC5260038, 0x460421C2, 0x46052A02, 0x460839C0, 0x46063202,
                0x460839C0, 0x460701C4, 0x00000000, 0x3C083F80, 0x44884000, 0x00000000,
                0x46074203, 0x00000000, 0x00000000, 0x46082102, 0x46082942, 0x46083182,
                0xC7A70030, 0xC7A80040, 0x460839C1, 0x46043A82, 0xC7A70034, 0xC7A80044,
                0x460839C1, 0x460539C2, 0x46075280, 0xC7A70038, 0xC7A80048, 0x460839C1,
                0x460639C2, 0x46075280, 0x3C0840E0, 0x44885800, 0x00000000, 0x460A5AC1,
                0x44805000, 0x00000000, 0x460B5034, 0x00000000, 0x450000FD, 0x00000000,
                ...
                0xC7A20068, 0x46051080, 0xC7A7008C, 0x460710A8, 0xC7A9005C, 0x46093043,
                ...
                0x0C052754, 0x00000000, 0x8FA30058, 0xC7A00094, 0xC7A20098, 0xC7A4009C,
                0xC7A50080, 0xC7A60088, 0x04400047, 0x00000000, 0x00024980, 0x00025100,
                0x012A4821, 0x02A94821, 0xC5270030, 0xC5280034, 0xC5290038, 0x46073A82,
                0x460842C2, 0x460B5280, 0x46094AC2, 0x460B5280, 0x460A0284, 0x00000000,
                0x3C083F80, 0x44885800, 0x00000000, 0x460A5AC3, 0x460B39C2, 0x460B4202,
                ...
                0x460A5AC1, 0x44085800, 0x00000000, 0x1900001C, 0x00000000, 0xC7AA0060,
                0x46075282, 0xC7A30064, 0x460918C2, 0x46035280, 0x460A58C2, 0x46030000,
                0x46032100, 0x460858C2, 0x46031080, 0x46032940, 0xC7AA0064, 0x46075282,
                0xC7A30060, 0x460918C2, 0x46035281, 0x460A58C2, 0x46033180, 0x460018C3,
                0x00000000, 0xC46A02D8, 0x460350C0, 0xE46302D8, 0xC7A3008C, 0x460310A8,
                0xC7A30090, 0x460310A9, 0x3C0B0014, 0x356BC210, 0xC7A70060, 0xC7A80064,
            ...
            PutVal(439, BASE_DIST, nameof(BASE_DIST));   // reacquisition rest target
            PutVal(456, BASE_DIST, nameof(BASE_DIST));   // climb intrusion reference
            PutVal(151, REST_H, nameof(REST_H));   // flat baseline
            PutVal(474, REST_H, nameof(REST_H));   // climb-curve base
            ...
            PutVal(264, SLIDE_MARGIN, nameof(SLIDE_MARGIN));   // proximity-extension reach
            PutVal(350, SLIDE_MARGIN, nameof(SLIDE_MARGIN));   // need standoff
            PutVal(555, SLIDE_MARGIN, nameof(SLIDE_MARGIN));   // corner second-resolution standoff
            PutVal(445, SLIDE_GAIN, nameof(SLIDE_GAIN));   // θ reacquisition
            ...
            PutEase(375, 376, SLIDE_BIAS, nameof(SLIDE_BIAS));
            PutEase(426, 427, SLIDE_FRICTION_INV, nameof(SLIDE_FRICTION_INV));
            PutEase(469, 470, CLIMB_K, nameof(CLIMB_K));
