...
namespace Dark_Cloud_Improved_Version
{
    ...
    internal static class IsoPatcher
    {
        ...
        static void PatchNativeCameraPostPass(FileStream fs, Func<uint, long> ElfOff)
        {
            ...
            const float SLIDE_GAIN = 0.125f; // reacquisition slide: fraction of the tangent-projected restoring pull applied per frame (0 = off; PutVal steps 0.0625/0.125/0.25)
            ...
            uint[] pullIn =
            {
                ...
                0x8C239678, 0x10600263, 0x00000000, 0xAFA30058, 0xC46002C0, 0xE7A00020,
                ...
                0xC46002C4, 0xE7A00024, 0xC46002C8, 0xE7A00028, 0x3C0842A0, 0x44884000,
                0x00000000, 0xC7A00060, 0x46080002, 0xC7A10020, 0x46000800, 0xE7A00030,
                0x3C084188, 0x44880800, 0x00000000, 0xC7A20024, 0x46011040, 0xE7A10034,
                ...
                0x0440003D, 0x00000000, 0x00024980, 0x00026100, 0x012C4821, 0x02A94821,
                0xC5240030, 0xC5250034, 0xC5260038, 0xC7A70030, 0xC7AA0020, 0x460A39C1,
                0x46072102, 0xC7A70034, 0xC7AA0024, 0x460A39C1, 0x46072942, 0x46052100,
                0xC7A70038, 0xC7AA0028, 0x460A39C1, 0x46073182, 0x46062100, 0x44802800,
                0x00000000, 0x46052034, 0x00000000, 0x45000022, 0x00000000, 0xC5240030,
                0xC5250034, 0xC5260038, 0x46042102, 0x460529C2, 0x46072100, 0x46063182,
                0x46062100, 0x3C083EB8, 0x350851EC, 0x44884000, 0x00000000, 0x46082102,
                0x46043834, 0x00000000, 0x45000011, 0x00000000, 0xC7A00040, 0xC7A10020,
                0x46010001, 0x46000002, 0xC7A20048, 0xC7A30028, 0x46031081, 0x46021082,
                0x46020000, 0x46000004, 0x3C084100, 0x44881000, 0x00000000, 0x46020001,
                0x10000004, 0x00000000, 0x3C0842A0, 0x44880000, 0x00000000, 0x3C084080,
                0x44881000, 0x00000000, 0x46020034, 0x00000000, 0x45000002, 0x00000000,
                0x46001006, 0x3C084188, 0x44881000, 0x00000000, 0x3C084270, 0x44882000,
                ...
                0x00000000, 0x46064181, 0x46063942, 0x46042942, 0x46022940, 0xC7A80068,
                0x46082940, 0xC7A6006C, 0xC7A70024, 0x46073181, 0x3C084160, 0x44883800,
                0x00000000, 0x46073181, 0x46053034, 0x00000000, 0x45000002, 0x00000000,
                0x46003146, 0xC7A6005C, 0xC7A70024, 0x46073181, 0x3C0840C0, 0x44883800,
                0x00000000, 0x46073180, 0x46062834, 0x00000000, 0x45000002, 0x00000000,
                0x46003146, 0xC46602D4, 0x460629C1, 0x3C083E99, 0x3508999A, 0x44881800,
                0x00000000, 0x460339C2, 0x46073180, 0xE7A60068, 0xC46102D0, 0x3C083E19,
                0x3508999A, 0x44881800, 0x00000000, 0x46010081, 0x46031082, 0x46020800,
                0xE7A0005C, 0xC7A1005C, 0xC7A20060, 0x46011082, 0xC46302C0, 0x46021880,
                0xE7A20030, 0xC46202C4, 0xC7A30068, 0x46031080, 0xE7A20034, 0xC7A20064,
                0x46011082, 0xC46302C8, 0x46021880, 0xE7A20038, 0xAFA0003C, 0x3C0B0014,
                0x356BC210, 0x8D680000, 0x8D690004, 0x8D6A0008, 0x01094025, 0x010A4025,
                0x110000F5, 0x00000000, 0xC5670000, 0xC7A80030, 0x460839C1, 0x46073A42,
                0xC5670004, 0xC7A80034, 0x460839C1, 0x460739C2, 0x46074A40, 0xC5670008,
                0xC7A80038, 0x460839C1, 0x460739C2, 0x46074A40, 0x3C084680, 0x44884000,
                0x00000000, 0x46094034, 0x00000000, 0x450100E0, 0x00000000, 0x3C083F80,
                0x44884000, 0x00000000, 0x46084834, 0x00000000, 0x4501001F, 0x00000000,
                0x46090244, 0x00000000, 0x3C0840E0, 0x44884000, 0x00000000, 0x46084A00,
                0x46094203, 0x00000000, 0x00000000, 0xC7A70030, 0xC5610000, 0x460139C1,
                0x460839C2, 0x460709C0, 0xE7A70070, 0xC7A70034, 0xC5610004, 0x460139C1,
                0x460839C2, 0x460709C0, 0xE7A70074, 0xC7A70038, 0xC5610008, 0x460139C1,
                0x460839C2, 0x460709C0, 0xE7A70078, 0xAFA0007C, 0x10000008, 0x00000000,
                0xC7A70030, 0xE7A70070, 0xC7A70034, 0xE7A70074, 0xC7A70038, 0xE7A70078,
                0xAFA0007C, 0x02A02021, 0x03C02821, 0x01603021, 0x27A70070, 0x27A80040,
                0xAFA80010, 0x24090001, 0xAFA90014, 0xAFA00018, 0x0C052754, 0x00000000,
                0x8FA30058, 0x044000A6, 0x00000000, 0x00024980, 0x00025100, 0x012A4821,
                ...
                0x45000077, 0x00000000, 0xC7A70060, 0x460439C2, 0xC7A80064, 0x46064202,
                ...
                0xE46302D8, 0x8FA80084, 0x15000017, 0x00000000, 0x3C0842A0, 0x44883800,
                0x00000000, 0x460039C1, 0xC7A90088, 0x46093AC2, 0x3C083E00, 0x44885000,
                0x00000000, 0x460958C2, 0x460338C1, 0x460A18C2, 0x46030000, 0x460C58C2,
                0x460018C7, 0x460A18C2, 0x460018C3, 0x00000000, 0x00000000, 0xC46902D8,
                0x46034A40, 0xE46902D8, 0x3C0B0014, 0x356BC210, 0xC7A70060, 0xC7A80064,
                0x46072042, 0x460830C2, 0x46030840, 0xC7A30030, 0x46011840, 0xE5610000,
                0xC7A30034, 0x460518C0, 0xE5630004, 0x46082042, 0x460730C2, 0x46030841,
                0xC7A30038, 0x46011840, 0xE5610008, 0xAD60000C, 0x1000000C, 0x00000000,
                0x3C0B0014, 0x356BC210, 0xC7A70030, 0xE5670000, 0xC7A70034, 0xE5670004,
                0xC7A70038, 0xE5670008, 0xAD60000C, 0xC7A0005C, 0xC7A20068, 0xE46002D0,
                0xE46202D4, 0x8FA20054, 0x8FBF0050, 0x03E00008, 0x27BD0090,
            };
            ...
            PutVal(236, MARGIN, nameof(MARGIN));
            PutVal(148, BASE_DIST, nameof(BASE_DIST));   // wall-ray extension length
            PutVal(242, BASE_DIST, nameof(BASE_DIST));   // no-wall resting distance
            PutVal(562, BASE_DIST, nameof(BASE_DIST));   // reacquisition-slide rest target
            PutVal(245, HFLOOR, nameof(HFLOOR));
            PutVal(156, REST_H, nameof(REST_H));   // wall-ray cast height
            PutVal(253, REST_H, nameof(REST_H));   // flat baseline
            PutVal(43, CEIL_DIST, nameof(CEIL_DIST));
            PutVal(298, MIN_CEIL_CLEAR, nameof(MIN_CEIL_CLEAR));
            PutVal(256, MAX_HEIGHT, nameof(MAX_HEIGHT));
            PutVal(260, CLIMB_START, nameof(CLIMB_START));
            PutVal(310, MIN_GROUND_CLEAR, nameof(MIN_GROUND_CLEAR));
            PutVal(392, SLIDE_MARGIN, nameof(SLIDE_MARGIN));   // proximity-extension reach
            PutVal(478, SLIDE_MARGIN, nameof(SLIDE_MARGIN));   // need standoff
            PutVal(568, SLIDE_GAIN, nameof(SLIDE_GAIN));   // reacquisition slide
            PutVal(122, STICK_SCALE, nameof(STICK_SCALE));
            PutEase(217, 218, WALL_MAX_NY2, nameof(WALL_MAX_NY2));
            PutEase(114, 115, STICK_DZ2, nameof(STICK_DZ2));
            PutEase(133, 134, STICK_EASE, nameof(STICK_EASE));
            PutEase(271, 272, INV_RANGE, nameof(INV_RANGE));
            PutEase(321, 322, HEIGHT_EASE, nameof(HEIGHT_EASE));
            PutEase(329, 330, DIST_EASE, nameof(DIST_EASE));
            PutEase(503, 504, SLIDE_BIAS, nameof(SLIDE_BIAS));
            PutEase(552, 553, SLIDE_FRICTION, nameof(SLIDE_FRICTION));
