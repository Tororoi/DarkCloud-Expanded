...
namespace Dark_Cloud_Improved_Version
{
    ...
    internal static class CameraCPolyProbe
    {
        ...
        private static void Monitor()
        {
            ...
            // Native camera scratch (see tools/town_camera_collision.s): E_prev quad @0x21F10050, stick ease @0x2014C20C:
        ...
        private static void MonitorFan()
        {
            ...
            float epx = Memory.ReadFloat(0x21F10050), epy = Memory.ReadFloat(0x21F10054), epz = Memory.ReadFloat(0x21F10058);
            _csvTick++;
