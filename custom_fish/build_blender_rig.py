...
Usage: python3 custom_fish/build_blender_rig.py [DONOR] [MESH_CHR]
...
Emits: custom_fish/blender/<DONOR>_rig.py
"""
...
def main():
    ...
    with open(OUT, "w") as f:
        f.write("# AUTO-GENERATED by custom_fish/build_blender_rig.py — open in Blender's Text editor and Run.\n")
